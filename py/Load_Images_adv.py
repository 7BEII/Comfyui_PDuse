...
class Load_Images_Advance:
    ...
    def load_images_recursive(self, directory: str, image_load_cap: int = 0, start_index: int = 0, load_always=False, sort_method: str = "numeric"):
        """
        ...
        print(f"排序方式: {sort_method} - 确保数字文件名按正确顺序加载")
